...
(function (factory) {
  ...
  function filterRange(newY, series, XOrY) {
    var options = series.options,
      ...
      availableMax = pick(options['availableMax' + XOrY], undefined),
      availableMin = pick(options['availableMin' + XOrY], undefined),
    ...
    if (newY < availableMin) {
      newY = 0;
    } else if (newY > availableMax) {
      newY = dragMax;
    }
